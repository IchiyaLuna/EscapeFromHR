...
void GameInitialize(short GamePhase) {
	...
	if (GamePhase == BuildingPhase) {
		...
		CurPos(1, 19); printf("¦­ Á¡ ¼ö¦­             ¦­ ÃÖ°íÁ¡¼ö¦­            ¦­");
		CurPos(1, 20); printf("¦±¦¬¦¬¦¬¦¬¦¬¦¬¦µ¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦µ¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦µ¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦°");
		...
		if (RankingData == NULL) {
			...
			if (ParityMaker(atoi(ScoreString)) != ParityChar) {
				...
				CurPos(23, 1); printf("¦®¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¯");
				CurPos(23, 2); printf("¦­       ÀúÀå µ¥ÀÌÅÍ°¡ ¼Õ»óµÇ¾ú½À´Ï´Ù...    ¦­");
				CurPos(23, 3); printf("¦±¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦°");
				CurPos(23, 4); printf("¦®¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¯");
				CurPos(23, 5); printf("¦­    ¾Æ¹« Å°³ª ´­·¯¼­ ÃÊ±âÈ­ ÈÄ °­Á¦Á¾·á   ¦­");
				CurPos(23, 6); printf("¦±¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦°");
				...
				if (RmResult == -1) {
					...
					printf("¾Ë ¼ö ¾ø´Â ¿À·ù ¹ß»ý!\n¾Æ¹« Å°³ª ´­·¯ °ÔÀÓÀ» °­Á¦ Á¾·áÇÕ´Ï´Ù...");
