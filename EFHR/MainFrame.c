...
void GameInitialize(short GamePhase) {
	...
	if (GamePhase == BuildingPhase) {
		...
		printf("¦­      ±×·¯´Ï Çö¸íÇÏ°Ô °Ç¼³À» ÁøÇàÇÏ°Ô      ¦­"); CurPos(1, 18);
		printf("¦­                                           ¦­"); CurPos(1, 19);
		printf("¦­                                           ¦­"); CurPos(1, 20);
		printf("¦±¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦°"); CurPos(1, 21);
		printf("¦®¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦³¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦³¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¯"); CurPos(1, 22);
		...
		printf("¦­ 1234567890123456¦­ ¿À ·ù ÀÓ¦­"); CurPos(1, 2);
		printf("¦²¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦´"); CurPos(1, 3);
		printf("¦­ "); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), Red);
		printf("°ø  Àå"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), White);
		...
		printf("¦­ 1234567890123456¦­ ¿À ·ù ÀÓ¦­"); CurPos(1, 4);
		printf("¦²¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦´"); CurPos(1, 5);
		printf("¦­ "); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), Green);
		printf("ÁÖ°ÅÁö"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), White);
		...
		printf("¦­ 1234567890123456¦­ ¿À ·ù ÀÓ¦­"); CurPos(1, 6);
		printf("¦±¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦µ¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦µ¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦µ¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦°"); CurPos(1, 10);
		printf("¦®¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¯"); CurPos(1, 11);
		printf("¦­                                           ¦­"); CurPos(1, 12);
		printf("¦­         <½ÅÀÔ »ç·É°üÀ» À§ÇÑ ¸Þ¸ð>         ¦­"); CurPos(1, 13);
		printf("¦­                                           ¦­"); CurPos(1, 14);
		printf("¦­             µµ½Ã¸¦ Àß °Ç¼³Çß±º            ¦­"); CurPos(1, 15);
		printf("¦­           ÁÂ¿ì·Î ÀÚ³×°¡ ¿òÁ÷ÀÌ¸é          ¦­"); CurPos(1, 16);
		printf("¦­       ÀÚ³×°¡ µµÂøÇÑ ±¸¿ªÀÇ °Ç¹°·ÎºÎÅÍ     ¦­"); CurPos(1, 17);
