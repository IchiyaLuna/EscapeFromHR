...
int main(void) {
	...
	DialogDisplay("°ÔÀÓÀ» Á¾·áÇÕ´Ï´Ù... ³ªÁß¿¡ ´Ù½Ã ºË°Ú½À´Ï´Ù ÁöÈÖ°ü´Ô.");
	return 0;
}
...
void UserInfo(void) {
	...
	printf("¦®¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦³¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¯\n");
	printf("¦­ ´ç½ÅÀÇ ÀÌ¸§Àº? (ÃÖ´ë ¿µ¹® 10ÀÚ ÇÑ±Û ºÒ°¡) ¦­           ¦­\n");
	printf("¦±¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦µ¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦°\n");
	...
	while (1) {
		...
		CursorView(0);
		CurPos(1, 3);
		printf("³²Àº ±ÛÀÚ ¼ö : %2d", 56 - curInfo.dwCursorPosition.X);
...
void CityInfo(void) {
	...
	printf("¦®¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦³¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¯\n");
	printf("¦­ ¹æ¾îÇÒ µµ½ÃÀÇ ÀÌ¸§Àº? (ÃÖ´ë ¿µ¹® 10ÀÚ ÇÑ±Û ºÒ°¡) ¦­           ¦­\n");
	printf("¦±¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦µ¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦°\n");
	...
	while (1) {
		...
		CursorView(0);
		CurPos(1, 3);
		printf("³²Àº ±ÛÀÚ ¼ö : %2d", 63 - curInfo.dwCursorPosition.X);
...
void GameInitialize(void) {
	...
	CurPos(1, 0);
	printf("¦®¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦³¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦³¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦³¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¯"); CurPos(1, 1);
	printf("¦­ "); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 14);
	  printf("¹ßÀü¼Ò"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 15);
	        printf("¦­ ³ôÀÌ 0¦­ °Ç¼³ °¡´É ¼ö : 0¦­ °Ç¼³ : e¦­"); CurPos(1, 2);
	printf("¦²¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦´"); CurPos(1, 3);
	printf("¦­ "); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 12);
	  printf("°ø  Àå"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 15);
	        printf("¦­ ³ôÀÌ 0¦­ °Ç¼³ °¡´É ¼ö : 0¦­ °Ç¼³ : t¦­"); CurPos(1, 4);
	printf("¦²¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¶¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦¬¦´"); CurPos(1, 5);
	printf("¦­ "); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 10);
	  printf("ÁÖ°ÅÁö"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 15);
